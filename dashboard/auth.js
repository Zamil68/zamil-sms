...
async function doLogin() {
  ...
  try {
    // Use raw fetch for login — NOT apiCall. apiCall adds session headers
    // and has session-expiry retry logic that interferes with the login flow.
    var _loginRes = await fetch(login.url, {
      method: "POST",
